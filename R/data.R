...
#'
#' Used in create_website_upload_csv() as a list of site names. Update 11/07/24 to change Ascensions to Henry Fords. Update 2/14/25 to correct Marshfield Dickinson. Update 6/4/25 to add McLaren Petoskey.
#'
#' @format ## `site_names`
...
#' Site MDHHS ID list
#'
#' Used in create_website_upload_csv() to map site names to MDHHS IDs. Update 11/07/24 to change Ascensions to Henry Fords. Update 2/14/25 to correct Marshfield Dickinson. Update 6/4/25 to add McLaren Petoskey.
#'
#' @format ## `site_names`
